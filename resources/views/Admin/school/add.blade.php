                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="default" class="form-horizontal" action="" method="post">
                                        ...
                                        <table class="display table table-bordered" style="width:1000px;">
                                            ...
                                            <tr class="text-center">
                                                <td class="bgw">姓　　名</td>
                                                <td class="bgw"><input type="text" class="form-control in_bgw" name="Name"></td>
                                                <td class="bgw">性　　别</td>
                                                <td class="bgw"><input type="text" class="form-control in_bgw" name="Sex"></td>
                                                <td class="bgw">民　　族</td>
                                                <td class="bgw"><input type="text" class="form-control in_bgw" name="Nation"></td>
                                                <td class="bgw" rowspan="4">
                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                        <input type="hidden" name="photo" id="filename" value="">
                                                        <div class="fileupload-new thumbnail">
                                                           <!-- <img src="" alt="" id="photoes">-->
                                                            <img src="http://www.placehold.it/80x100/EFEFEF/AAAAAA&amp;text=照片" alt="" id="photoes" style="width:120px;height:150px;">
                                                        </div>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="bgw">
                                                    <input name="Born" class="form-control in_bgw" type="text">
                                                </td>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td class="bgw" colspan="5"><input name="Address" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                            <tr class="text-center">
                                                <td class="bgw">证件期限</td>
                                                <td class="bgw" colspan="5"><input name="qixian" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="display table table-bordered" style="width:1000px;">
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td><input name="student_num" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw" style="width: 14%;">学　　历</td>
                                                <td><input name="edu" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw" style="width: 14%;">政治面貌</td>
                                                <td><input name="political_status" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                            <tr class="text-center">
                                                <td class="bgw">手机号码</td>
                                                <td><input name="phone_num" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw">身　　高</td>
                                                <td><input name="student_height" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw">体　　重</td>
                                                <td><input name="student_weight" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                        </table>
                                        <table class="display table table-bordered" style="width:1000px;">
                                            <tr class="text-center">
                                            ...
                                            <tr class="text-center">
                                                <td class="bgw" style="width: 14%;">学院名称</td>
                                                <td colspan="5" ><input name="school_name" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                            <tr class="text-center">
                                                <td class="bgw" style="width: 14%;">专业名称</td>
                                                <td><input name="major_name" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw" style="width: 14%;">专业类型</td>
                                                <td><input name="major_type" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw" style="width: 14%;">学　　制</td>
                                                <td><input name="major_date" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                            <tr class="text-center">
                                                <td class="bgw">班　　级</td>
                                                <td><input name="student_class" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw">班 主 任</td>
                                                <td><input name="teacher" type="text" class="form-control in_bgw"></td>
                                                <td class="bgw">入学时间</td>
                                                <td><input name="come_time" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                        </table>
                                        <table class="display table table-bordered" style="width:1000px;">
                                            <tr class="text-center">
                                            ...
                                            <tr class="text-center">
                                                <td><input name="graduation_school[]" type="text" class="form-control in_bgw"></td>
                                                <td><input name="major_study[]" type="text" class="form-control in_bgw"></td>
                                                <td><input name="education[]" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                            <tr class="text-center">
                                                <td><input name="graduation_school[]" type="text" class="form-control in_bgw"></td>
                                                <td><input name="major_study[]" type="text" class="form-control in_bgw"></td>
                                        ...
                                        <table class="display table table-bordered" style="width:1000px;">
                                            ...
                                            <tr class="text-center">
                                                <td><input name="parents_name[]" type="text" class="form-control in_bgw"></td>
                                                <td><input name="parents_relationship[]" type="text" class="form-control in_bgw"></td>
                                                <td><input name="parents_company[]" type="text" class="form-control in_bgw"></td>
                                                <td><input name="parents_phone[]" type="text" class="form-control in_bgw"></td>
                                            </tr>
                                            <tr class="text-center">
                                                <td><input name="parents_name[]" type="text" class="form-control in_bgw"></td>
                                                <td><input name="parents_relationship[]" type="text" class="form-control in_bgw"></td>
