                                        ...
                                        <form id="default" class="form-horizontal" action="" method="post">
                                            ...
                                            <table class="display table table-bordered" style="width:1000px;">
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="bgw">
                                                        <input name="Police" class="form-control in_bgw" type="text">
                                                    </td>
                                                    <td class="bgw">证件期限</td>
                                                    <td class="bgw" colspan="3">
                                                        <input class="form-control in_bgw" type="text" name="qixian">
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="display table table-bordered" style="width:1000px;">
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><input name="phone" type="text" class="form-control in_bgw"></td>
                                                    <td class="bgw" style="width: 14%;">电子邮箱</td>
                                                    <td colspan="3"><input name="email" type="text" class="form-control in_bgw"></td>
                                                </tr>
                                                <tr class="text-center">
                                                    <td class="bgw">家庭地址</td>
                                                    <td colspan="5"><input name="home_address" type="text" class="form-control in_bgw"></td>
                                                </tr>
                                                <tr class="text-center">
                                                    <td class="bgw" style="width: 14%;">学生来源</td>
                                                    <td><input name="student_source" type="text" class="form-control in_bgw"></td>
                                                    <td class="bgw" style="width: 14%;">推 荐 人</td>
                                                    <td><input name="referee" type="text" class="form-control in_bgw"></td>
                                                    <td class="bgw" style="width: 14%;">联系电话</td>
                                                    <td><input name="referee_phone" type="text" class="form-control in_bgw"></td>
                                                </tr>
                                            </table>
                                            <table class="display table table-bordered" style="width:1000px;">
                                                <tr class="text-center">
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><input name="school_name" type="text" class="form-control in_bgw"></td>
                                                    ...
                                                    <td><input name="major" type="text" class="form-control in_bgw"></td>
                                                </tr>
                                                <tr class="text-center">
                                                    <td class="bgw">报考日期</td>
                                                    <td><input name="examination_date" type="text" class="form-control in_bgw"></td>
                                                    <td class="bgw">注册日期</td>
                                                    <td><input name="register_date" type="text" class="form-control in_bgw"></td>
                                                    <td class="bgw">学籍状态</td>
                                                    <td><input name="school_status" type="text" class="form-control in_bgw"></td>
                                                </tr>
                                            </table>
                                            <table class="display table table-bordered" style="width:1000px;">
                                                <tr class="text-center">
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td><input name="receive_date" type="text" class="form-control in_bgw"></td>
                                                    <td class="bgw" style="width: 14%;">领 取 人</td>
                                                    <td><input name="receive_people" type="text" class="form-control in_bgw"></td>
                                                </tr>
                                            </table><br>
                                            <center>
