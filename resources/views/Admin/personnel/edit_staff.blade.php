                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td class="bgw" rowspan="4">
                                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                                            <input type="hidden" name="photo" id="filename" value="{{ $staffMsg->photo }}">
                                ...
                                <div id="xszs" class="tab-pane"><div class="panel-body">
                                        ...
                                        <form class="form-horizontal" role="form" action="{{ url('admin/personnel/add_entry') }}" method="post">
                                            ...
                                            <table class="display table table-bordered" style="width:1000px;">
                                                ...
                                                <tr class="text-center">
                                                    <td class="bgw">员工编号</td>
                                                    <td colspan="2"><input type="text" class="form-control" readonly name="staff_num" value="{{ $staffMsg->staff_num }}"></td>
                                                    <td class="bgw">员工姓名</td>
                                                    <td colspan="2"><input type="text" class="form-control" readonly name="staff_num" value="{{ $staffMsg->staff_name }}"></td>
                                                </tr>
                                                <tr class="text-center">
                                                    <td class="bgw">部　　门</td>
                                                    <td class="bgw">
