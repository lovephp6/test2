                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="label label-danger"><a href="{{ url('admin/school/add') }}" style="color:#FFF;">　　支出凭证　　</a></span>
                        ...
                        <div class="panel-body">
                            ...
                            <center>
                                <form class="form-inline" role="form" action="" method="post">
                                    ...
                                    <div class="form-group">
                                        付款日期：<input type="text" class="form-control" size="54" name="collection_date" value="{{ date('Y-m-d',time()) }}">　
                                    </div>
                                    <div class="form-group">
                                        付款方式：<input type="text" class="form-control" size="54" name="payment_method">
                                    </div> <br><br>
                                    <div class="form-group">
                                    ...
                                    <table class="table table-bordered text-center" style="width:1000px;">
                                        ...
                                        <tr class="a_money">
                                            ...
                                            <td rowspan="2" style="padding:0;"><input onchange="cc(this.value,this)" type="text" name="unit_price1" style="width:100%;height:40px;border:none;text-align: center;" value="0"></td>
                                        ...
                                        <tr >
                                            ...
                                            <td rowspan="2" style="padding:0;"><input type="text" name="unit[]" style="width:100%;height:40px;border:none;text-align: center;"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" onchange="cc(this.value,this)" name="unit_price2" style="width:100%;height:40px;border:none;text-align: center;" value="0"></td>
                                        ...
                                        <tr >
                                            ...
                                            <td rowspan="2" style="padding:0;"><input type="text" value="1" name="number[]" style="width:100%;height:40px;border:none;text-align: center;"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="unit[]" style="width:100%;height:40px;border:none;text-align: center;"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" onchange="cc(this.value,this)" name="unit_price3" style="width:100%;height:40px;border:none;text-align: center;" value="0"></td>
                                        ...
                                        <tr >
                                            ...
                                            <td rowspan="2" style="padding:0;"><input type="text" value="1" name="number[]" style="width:100%;height:40px;border:none;text-align: center;"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="unit[]" style="width:100%;height:40px;border:none;text-align: center;"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" onchange="cc(this.value,this)" name="unit_price4" style="width:100%;height:40px;border:none;text-align: center;" value="0"></td>
                                    ...
                                    <div class="form-group" style="padding:0 80px;">
                                        付款人：<select class="form-control" name="payee">
                                            <option value="郑秀儿">郑秀儿</option>
                                            <option value="江忠泉">江忠泉</option>
                                        </select>　
                                    </div>
                                    <div class="form-group">
                                        付款单位：<select class="form-control" name="collecting_unit">
                                            <option value="财务部">财务部</option>
                                            <option value="出纳部">出纳部</option>
                                        </select>　
                                    </div>
                                    <div class="form-group" style="padding-left:110px;">
                                        付款日期：<input type="text" class="form-control" name="collecting_date" value="{{ date('Y-m-d',time())}}">
                                    </div>
