                                ...
                                <form action="" method="post">
                                    ...
                                    <table class="table table-bordered text-center" style="width:60%;">
                                        ...
                                        <tr>
                                            ...
                                            <td> <input class="form-control in_bgw" type="text" name="" value="{{ isset($student_msg) ? $student_msg->Name : ''}}"></td>
                                            <td class="form_line_height">性　　别</td>
                                            <td> <input class="form-control in_bgw" type="text" name="" value="{{ isset($student_msg) ? $student_msg->Sex : ''}}"></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td> <input class="form-control in_bgw" type="text" name="" value="{{ isset($student_msg) ? $student_msg->CardNo : ''}}"></td>
                                            <td class="form_line_height">出生日期</td>
                                            <td> <input class="form-control in_bgw" type="text" name="" value="{{ isset($student_msg) ? date('Y-m-d' ,$student_msg->Born) : ''}}"></td>
                                        </tr>
                                        <tr>
                                            <td class="form_line_height">专业名称</td>
                                            <td> <input class="form-control" type="text" name=""  value="{{ isset($student_msg) ? $student_msg->major_name : ''}}"></td>
                                            <td class="form_line_height">专业类型</td>
                                            <td> <input class="form-control in_bgw" type="text" name="" value="{{ isset($student_msg) ? $student_msg->major_type : ''}}"></td>
                                            <td class="form_line_height">学　　制</td>
                                            <td> <input class="form-control in_bgw" type="text" name="" value="{{ isset($student_msg) ? $student_msg->major_date : ''}}"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="6"></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>退费原因</td>
                                            <td colspan="5"><input class="form-control in_bgw" type="text" name="refund_reasons" value="{{ $refund_msg->refund_reasons }}"></td>
                                        </tr>
                                        <tr>
                                            <td class="form_line_height">申请编号</td>
                                            <td><input class="form-control in_bgw" type="text" name="app_number" value="{{ $refund_msg->app_number }}"></td>
                                            <td class="form_line_height">扣款金额</td>
                                            <td><input class="form-control in_bgw" type="text" name="amount" value="{{ $refund_msg->amount }}"></td>
                                            <td class="form_line_height">退款金额</td>
                                            <td><input class="form-control in_bgw" type="text" name="refund_amount" value="{{ $refund_msg->refund_amount }}"></td>
                                        </tr>
                                        <tr>
                                            <td class="form_line_height">退款方式</td>
                                            <td><input class="form-control in_bgw" type="text" name="refund_method" value="{{ $refund_msg->refund_method }}"></td>
                                            <td class="form_line_height">退款单号</td>
                                            <td><input class="form-control in_bgw" type="text" name="refund_num" value="{{ $refund_msg->refund_num }}"></td>
                                            <td class="form_line_height">退款日期</td>
                                            <td><input class="form-control in_bgw" type="text" name="refund_date" value="{{ date('Y-m-d',$refund_msg->refund_date) }}"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="6"><button class="btn btn-info">　　修改　　</button>　　 </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
