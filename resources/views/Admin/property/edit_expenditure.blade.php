                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <span class="label label-danger"><a href="{{ url('admin/school/add') }}" style="color:#FFF;">　　修改凭证　　</a></span>
                            ...
                            <center>
                                <form class="form-inline" role="form" action="" method="post">
                                    ...
                                    <div class="form-group">
                                        付款单位：<input type="text" class="form-control" size="54" name="payment_unit" value="{{ $expenditure->payment_unit }}">　
                                    </div>
                                    <div class="form-group">
                                        &nbsp;经 手 人：<input type="text" class="form-control" size="54" name="handle_person" value="{{ $expenditure->handle_person }}">
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                        票据编号：<input type="text" class="form-control" size="54" name="bill_number" value="{{ $expenditure->bill_number }}">　
                                    </div>
                                    <div class="form-group">
                                        发票编号：<input type="text" class="form-control" size="54" name="invoice_number" value="{{ $expenditure->invoice_number }}">
                                    </div><br><br>
                                    <div class="form-group">
                                        收款日期：<input type="text" class="form-control" size="54" name="collection_date" value="{{ date('Y-m-d',$expenditure->collection_date) }}">　
                                    </div>
                                    <div class="form-group">
                                        收款方式：<input type="text" class="form-control" size="54" name="payment_method" value="{{ $expenditure->payment_method }}">
                                    </div> <br><br>
                                    <div class="form-group">
                                        备　　注：<input type="text" class="form-control" size="126px;" name="remarks" value="{{ $expenditure->remarks }}">
                                    </div>
                                    <br><br>
                                    <table class="table table-bordered text-center" style="width:1000px;">
                                        ...
                                        <tr class="a_money">
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->abstract[0] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="number[]" value="1" class="number" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->number[0] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="unit[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->unit[0] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input onblur="cc(this.value,this)" type="text" name="unit_price1" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->unit_price[0] }}"></td>
                                        ...
                                        <tr >
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->abstract[1] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="number[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->number[1] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="unit[]" style="width:100%;height:40px;border:none;text-align: center;"  value="{{ $expenditure->unit[1] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" onblur="cc(this.value,this)" name="unit_price2" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->unit_price[1] }}"></td>
                                        ...
                                        <tr style="height:40px;"></tr>
                                        <tr >
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->abstract[2] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" value="{{ $expenditure->number[2] }}" name="number[]" style="width:100%;height:40px;border:none;text-align: center;"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="unit[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->unit[2] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" onblur="cc(this.value,this)" name="unit_price3" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->unit_price[2] }}"></td>
                                        ...
                                        <tr style="height:40px;"></tr>
                                        <tr >
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->abstract[3] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" value="{{ $expenditure->number[3] }}" name="number[]" style="width:100%;height:40px;border:none;text-align: center;"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" name="unit[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->unit[3] }}"></td>
                                            <td rowspan="2" style="padding:0;"><input type="text" onblur="cc(this.value,this)" name="unit_price4" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $expenditure->unit_price[3] }}"></td>
                                        ...
                                        <tr style="height:40px;"></tr>
                                        <tr >
                                            <td rowspan="2" colspan="4" style="text-align: left;padding:0px">　合计（大写）人民币：<input type="text" name="total" style="width:80%;height:40px;border:none;" value="{{ $expenditure->total }}"></td>
                                    ...
                                    <div class="form-group" style="margin-left:20px;">
                                        开票人：<select class="form-control" name="drawer">
                                            <option value="郑秀儿" @if($expenditure->drawer == '郑秀儿') selected @endif >郑秀儿</option>
                                            <option value="江忠泉" @if($expenditure->drawer == '江忠泉') selected @endif >江忠泉</option>
                                        </select>
                                    </div>
                                    <div class="form-group" style="padding:0 80px;">
                                        收款人：<select class="form-control" name="payee">
                                            <option value="郑秀儿" @if($expenditure->payee == '郑秀儿') selected @endif >郑秀儿</option>
                                            <option value="江忠泉" @if($expenditure->payee == '江忠泉') selected @endif >江忠泉</option>
                                        </select>　
                                    </div>
                                    <div class="form-group">
                                        收款单位：<select class="form-control" name="collecting_unit">
                                            <option value="财务部" @if($expenditure->collecting_unit == '财务部') selected @endif >财务部</option>
                                            <option value="出纳部" @if($expenditure->collecting_unit == '出纳部') selected @endif >出纳部</option>
                                        </select>　
                                    </div>
                                    <div class="form-group" style="padding-left:110px;">
                                        收款日期：<input type="text" class="form-control" name="collecting_date" value="{{ date('Y-m-d',$expenditure->collecting_date )}}">
                                    </div>
