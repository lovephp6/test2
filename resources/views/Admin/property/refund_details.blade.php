                                ...
                                @foreach($studentTuition as $studentTuition)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary btn-xs" href="{{ url('admin/property/edit_refund',['id' => $studentTuition->id]) }}"><i class="fa fa-pencil" style="font-size:18px;"></i></a>
                                            <a class="btn btn-danger btn-xs" href="javascript:void(0);" onclick="del('{{ url('admin/property/delete_refund') }}',{{ $studentTuition->id }},'{{ csrf_token() }}')"><i class="fa  fa-trash-o" style="font-size:18px;"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
