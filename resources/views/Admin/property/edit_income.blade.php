                            ...
                            <center>
                                <form class="form-inline" role="form" action="" method="post">
                                    ...
                                    <div class="form-group">
                                        付款单位：<input type="text" class="form-control" size="54" name="payment_unit" value="{{ $income->payment_unit }}">　
                                    </div>
                                    <div class="form-group">
                                        &nbsp;经 手 人：<input type="text" class="form-control" size="54" name="handle_person" value="{{ $income->handle_person }}">
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                        票据编号：<input type="text" class="form-control" size="54" name="bill_number" value="{{ $income->bill_number }}">　
                                    </div>
                                    <div class="form-group">
                                        发票编号：<input type="text" class="form-control" size="54" name="invoice_number" value="{{ $income->invoice_number }}">
                                    </div><br><br>
                                    <div class="form-group">
                                        收款日期：<input type="text" class="form-control" size="54" name="collection_date" value="{{ date('Y-m-d',$income->collection_date) }}">　
                                    </div>
                                    <div class="form-group">
                                        收款方式：<input type="text" class="form-control" size="54" name="payment_method" value="{{ $income->payment_method }}">
                                    </div> <br><br>
                                    <div class="form-group">
                                        备　　注：<input type="text" class="form-control" size="126px;" name="remarks" value="{{ $income->remarks }}">
                                    </div>
                                    <br><br>
                                    <table class="table table-bordered text-center" style="width:1000px;">
                                        ...
                                        <tr class="a_money">
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->abstract[0] }}"></td>
                                            ...
                                            <td rowspan="2" style="padding:0;"><input onblur="cc(this.value,this)" type="text" name="unit_price1" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->unit_price[0] }}"></td>
                                        ...
                                        <tr >
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->abstract[1] }}"></td>
                                            ...
                                            <td rowspan="2" style="padding:0;"><input type="text" onblur="cc(this.value,this)" name="unit_price2" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->unit_price[1] }}"></td>
                                        ...
                                        <tr style="height:40px;"></tr>
                                        <tr >
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->abstract[2] }}"></td>
                                            ...
                                            <td rowspan="2" style="padding:0;"><input type="text" onblur="cc(this.value,this)" name="unit_price3" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->unit_price[2] }}"></td>
                                        ...
                                        <tr style="height:40px;"></tr>
                                        <tr >
                                            <td rowspan="2" style="padding:0;"><input type="text" name="abstract[]" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->abstract[3] }}"></td>
                                            ...
                                            <td rowspan="2" style="padding:0;"><input type="text" onblur="cc(this.value,this)" name="unit_price4" style="width:100%;height:40px;border:none;text-align: center;" value="{{ $income->unit_price[3] }}"></td>
                                        ...
                                        <tr style="height:40px;"></tr>
                                        <tr >
                                            <td rowspan="2" colspan="4" style="text-align: left;padding:0px">　合计（大写）人民币：<input type="text" name="total" style="width:80%;height:40px;border:none;" value="{{ $income->total }}"></td>
                                    ...
                                    <div class="form-group" style="padding:0 80px;">
                                        收款人：<select class="form-control" name="payee">
                                            <option value="郑秀儿" @if($income->payee == '郑秀儿') selected @endif >郑秀儿</option>
                                            <option value="江忠泉" @if($income->payee == '江忠泉') selected @endif >江忠泉</option>
                                        </select>　
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" style="padding-left:110px;">
                                        收款日期：<input type="text" class="form-control" name="collecting_date" value="{{ date('Y-m-d',$income->collecting_date )}}">
                                    </div>
